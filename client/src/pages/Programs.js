...
const TRACKS = [
  {
    id: 1, type: 'bootcamp', icon: 'bi-mortarboard-fill', color: 'var(--primary)',
    ...
    outcome: 'Graduate with your first deployed smart contract and a CyberPhunk NFT credential.',
    capacity: 200, badge: 'badge-bootcamp',
  },
  {
    id: 2, type: 'hackathon', icon: 'bi-lightning-charge-fill', color: 'var(--secondary)',
    title: 'Global Hackathon', subtitle: '72-Hour Sprint',
    description: '72-hour global hackathon focused on Web3 innovation. Compete for $50,000 in prizes across Privacy, DeFi, and Marketplace categories.',
    modules: ['Marketplace Innovation', 'Collaborative Tools', 'DeFi Integration', 'On-chain Reputation', 'Open Category'],
    outcome: 'Build a working prototype, pitch to a panel of VCs, and win up to $25,000.',
    capacity: 500, badge: 'badge-hackathon',
  },
  {
    id: 3, type: 'accelerator', icon: 'bi-rocket-takeoff-fill', color: 'var(--accent)',
    title: 'Web3 Accelerator', subtitle: '12-Week Program',
    description: '12-week intensive accelerator for early-stage Web3 startups. Receive seed investment, expert mentorship, and VC introductions.',
    modules: ['Product-Market Fit', 'Tokenomics Design', 'Smart Contract Architecture', 'Go-to-Market Strategy', 'Fundraising & Pitching'],
    outcome: 'Graduate with seed funding, 3 months of mentorship, and warm introductions to 50+ VCs.',
    capacity: 30, badge: 'badge-accelerator',
  },
  {
    id: 4, type: 'village', icon: 'bi-house-fill', color: '#00FF88',
    title: 'Pop-up Village', subtitle: 'Week-Long Residency',
    description: 'A week-long co-living and co-working experience for Web3 builders. Build, connect, and ship together in a tech-focused environment.',
    modules: ['Morning Workshops', 'Build Sessions', 'Speaker Fireside Chats', 'Networking Dinners', 'Demo Day'],
    outcome: 'Launch a project with your cohort and build lasting global connections.',
...
const SCHEDULE = [
  ...
  { date: '2026-07-15', title: 'Global CyberPhunk Hackathon', type: 'hackathon', location: 'Berlin + Online', spots: 188 },
  ...
  return (
    <>
      ...
      <section style={{ paddingTop: '140px', paddingBottom: '80px', background: 'linear-gradient(to bottom, var(--bg-surface), var(--bg-deep))', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(rgba(255,107,0,0.08) 1px, transparent 1px)', backgroundSize: '50px 50px' }} />
      ...
      <section style={{ background: 'var(--bg-surface)', borderTop: '1px solid var(--border-glass)', borderBottom: '1px solid var(--border-glass)', padding: '30px 0' }}>
        <div className="container">
          <div className="row g-3 text-center">
            {[
              { icon: 'bi-people-fill', value: '5,200+', label: 'Alumni', color: 'var(--primary)' },
              { icon: 'bi-globe2', value: '32', label: 'Countries', color: 'var(--secondary)' },
              { icon: 'bi-trophy-fill', value: '$500K+', label: 'Prizes Awarded', color: 'var(--accent)' },
              { icon: 'bi-briefcase-fill', value: '78%', label: 'Job Placement', color: '#00FF88' },
                  ...
                  <div className="glass-card p-4 mb-3 d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div className="d-flex align-items-center gap-4 flex-wrap">
                      <div style={{ minWidth: 100, textAlign: 'center' }}>
                        <div style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: '1.4rem', color: 'var(--primary)' }}>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, color: 'var(--primary)' }}>
              ...
              <div className="modal-body p-4">
                ...
                {status === 'success' ? (
                  <div className="text-center py-4">
                    <i className="bi bi-check-circle-fill" style={{ fontSize: '3rem', color: '#00FF88', display: 'block', marginBottom: 16 }}></i>
                    <h5 style={{ fontFamily: 'var(--font-heading)', color: '#00FF88' }}>Registration Confirmed!</h5>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>You're on the list. We'll send details to your email.</p>
                    <button className="btn-solid-primary mt-3" onClick={() => { setShowModal(false); setStatus(''); }}>Done</button>
                  </div>
                ) : (
